...
namespace Yesdude.Rotate
{
    public class Display
    {
        ...
        public static bool VerifyDisplayNumber(uint DisplayNumber)
        {
            ...
            {
                return (0 != NativeMethods.EnumDisplaySettings(
        ...
        public static void Identify(uint screenId)
        {
            Screen[] screens = Screen.AllScreens;

            Rectangle screenRect = screens[screenId-1].Bounds;

            FormScreenNumber showScreenNumber = new FormScreenNumber();

            int addX = (screenRect.Width / 2) - (showScreenNumber.Width / 2);
            int addY = (screenRect.Height / 2) - (showScreenNumber.Height / 2);

            showScreenNumber.SetDesktopLocation(screenRect.X + addX, screenRect.Y + addY);
            showScreenNumber.StartPosition = FormStartPosition.Manual;
            showScreenNumber.ScreenNumber((int)screenId);
            showScreenNumber.SetTransparency();

            showScreenNumber.Show();
        }
    }
